...
Require-Text $browserRuntime "startTimeSeconds" "Filter Builder browser helper must expose ranged preview start time."
Require-Text $browserRuntime "durationSeconds" "Filter Builder browser helper must expose bounded preview duration."
