...
The same GitHub Release also contains `ffmpeg-wasm-sources-<version>.tar.gz` with the exact FFmpeg, x264, and Emscripten source revisions plus this Builder recipe.
